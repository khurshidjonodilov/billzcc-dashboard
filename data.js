const BILLZ_DATA = {
  "monthly": {
    ...
    "top_companies": [
      ...
      },
      {
        ...
        "top_labels": [
          ...
          {
            "label": "Отчёты - Выгрузка отчёта, Баг (реквест)",
            "count": 2
          }
        ]
      }
    ...
    "sla_note": "SLA измеряется по чатам (FRT≤1мин). По звонкам SLA >90% (данные из онлайн-АТС)",
    "csat_rated": 674,
    "training_tickets": 432,
    "team_changes": [
      {
        "name": "Шохинабону",
        "status": "уволена",
        "reason": "Учёба — не может совмещать",
        "peak": "17:00-22:00"
      },
      {
        "name": "Нурлан",
    ...
    "chat_causes": [
      {
        "rank": 1,
        "cause": "Технические темы требуют звонка",
        "detail": "Принтеры, Desktop, EPOS, Инвентаризация — невозможно решить в чате"
      },
      {
        "rank": 2,
        "cause": "Срочность = звонок",
        "detail": "Кассовые смены, вход в аккаунт — клиент в магазине, нужен быстрый ответ"
      },
      {
        "rank": 3,
        "cause": "Корреляция с LCR",
        "detail": "При высоком LCR недозвонившиеся пишут в чат. При низком — чаты падают"
      },
      {
        "rank": 4,
        "cause": "Нет IVR-перевода в чат",
        "detail": "Отсутствует скрипт и опция перевода клиента в чат"
      },
      {
        "rank": 5,
        "cause": "Рост базы новых клиентов",
        "detail": "Новые магазины на онбординге звонят чаще — повышают долю звонков"
      }
    ]
  },
  "weekly": {
    "week_14": {
      "label": "Нед 14 · 1–5 апр",
      "week_num": 14,
      "tickets": 2422,
      "calls": 1306,
      "chats": 1116,
  ...
  "quarterly": {
    ...
    "summary": {
      ...
      "frt_med_sec": 24.0,
      "repeat_pct_avg": 7.8,
      "undesired_pct_avg": 51.4,
      "massoviy_tickets": 1965,
      "massoviy_cost_mln": 19.4,
      "training_tickets": 2305,
    ...
    "by_month": [
      {
        ...
        "frt_avg_sec": 60,
        "cost_mln": 105.53,
        "cost_per_ticket": 10058,
        "repeat_pct": 6.2,
        "undesired_pct": 47.4,
        "training_tickets": 709,
        "cpt": 10058
      },
      {
        "name": "Февраль",
        ...
        "frt_avg_sec": 69,
        "cost_mln": 121.43,
        "cost_per_ticket": 9670,
        "repeat_pct": 6.3,
        "undesired_pct": 52.3,
        "training_tickets": 592,
        "cpt": 9670
      },
      {
        "name": "Март",
    ...
    "recommendations": [
      {
        "priority": 1,
        "color": "#EF4444",
        "title": "Набор операторов — КРИТИЧНО",
        "detail": "Команда работает на 11 операторах при норме 13–14. Уволились Шохинабону и Нурлан — пиковые часы 17–22ч не перекрыты. LCR апреля вырос до 7.8% (план 3%). Нужно закрыть 2–3 вакансии до конца мая.",
        "metric": "LCR апр: 7.80% ↑ vs цель 3%",
        "action": "Заявка в HR подана — ускорить найм"
      },
      {
        "priority": 2,
        "color": "#F59E0B",
        "title": "Передача онбординга в CS",
        "detail": "432 тикета-обучения через CC за апрель = 4.3 млн сум затрат CC. Это работа CS-команды. За квартал: 2 304 обучения = 22.7 млн сум. Стандарт онбординга через CS снизит нагрузку на CC.",
        "metric": "Обучения апр: 432 тик · 4.3 млн сум",
        "action": "Утвердить стандарт онбординга CS до 15 мая"
      },
      {
        "priority": 3,
        "color": "#8B5CF6",
        "title": "IVR — перевод звонков в чаты",
        "detail": "Доля чатов снизилась с 51.3% (нед 12) до 39.9% (нед 17) — исторический минимум. Без IVR-опции перехода в чат тренд продолжится. Технические темы (принтеры, EPOS) невозможно решить в чате без шаблонов.",
        "metric": "Доля чатов нед 17: 39.9% vs норма 47%+",
        "action": "Запрос на IVR-доработку + FAQ топ-5 тем"
      },
      {
        "priority": 4,
        "color": "#10B981",
        "title": "Снижение нежелательных обращений",
        "detail": "Нежелательные составляют 49.5% всех тикетов апреля. Топ причин: необученные клиенты на онбординге, повторные обращения по базовым темам (Кассовые смены, Документооборот). Цель — снизить до <40% к июлю.",
